...
near call  ${defi_contract_id}  isValid   '{"fungible_token_account_id":"'${nep1_contract_id}'"}' --account-id shark.testnet 
near call  ${defi_contract_id}  add   '{"fungible_token_account_id":"'${nep2_contract_id}'"}' --account-id shark.testnet 
near call  ${defi_contract_id}  isValid   '{"fungible_token_account_id":"'${nep2_contract_id}'"}' --account-id shark.testnet 
